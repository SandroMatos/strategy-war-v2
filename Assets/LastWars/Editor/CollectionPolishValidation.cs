        ...
        static void Tick()
        {
            ...
            try
            {
                if (phase == 0)
                {
                    ...
                    var ui = new GameObject("Fixture UI",typeof(RectTransform)).AddComponent<FrontierView>(); ui.Initialize(); ui.Hud(data,"Prévia dos quatro recursos");
                ...
                if(phase==4)
                {
                    ...
                    Finish(!hadError,"Full-panel bars; four resource prefabs; one-shot emission; no zero-amount burst; automatic cleanup.");
                }
            }
